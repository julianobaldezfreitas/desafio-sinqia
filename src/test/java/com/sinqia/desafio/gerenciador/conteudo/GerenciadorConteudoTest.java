...
public class GerenciadorConteudoTest {
	...
	public void setUp() {
		...
		linhasArquivo.add("003Á21Á[1-5-10,2-1-1.50,3-40-1.55]ÁVanessa");
		//linhasArquivo.add("005Á21ÁVanessa");
		linhasArquivo.add("003Á22Á[1-34-1000,2-33-1.50,3-40-0.10]ÁJuliano");
	}

	@Test
	public void testeDadosVendedor() throws MonitorException {
		String linha = "001Á1234567891234ÁPedroÁ50000";
	...
	public void testeDadosCliente() throws MonitorException {
		String linha = "002Á2345675434544345ÁJose da SilvaÁRural";
		this.gerenciadorConteudo.geraConteudo(linha);
	...
	public void testeDadosVenda() throws MonitorException {
		String linha = "003Á21Á[1-34-1000,2-33-1.50,3-40-0.10]ÁVanessa";
		this.gerenciadorConteudo.geraConteudo(linha);
	...
	public void testeDadosVendaPorVendedor() throws MonitorException {
		...
		//34053.50
		//003Á22Á[1-34-1000,2-33-1.50,3-40-0.10]ÁJuliano
		...
		//113.50
		//003Á21Á[1-5-10,2-1-1.50,3-40-1.55]ÁVanessa
